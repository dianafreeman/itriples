...
<div class="form-group">
            ...
            <? } else { ?>
              ...
              jQuery('#register-links btn').removeClass('hidden');
...
<a id="professional-register" class="btn btn-outline-primary hidden" href="<?php echo esc_url(get_site_url().'/register/?membership_id=24') ;?>">Create my Account</a>

<a id="student-register" class="btn btn-outline-primary hidden" href="<?php echo esc_url(get_site_url().'/register/?membership_id=87') ;?>">Create my Account</a>
</div>
