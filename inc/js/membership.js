...
jQuery('input#prof-degree-other-specify').change(
  function(){
    if (jQuery('input#prof-degree-other-specify').prop('checked') ) {
         jQuery('.prof-degree-other').removeClass('hidden') 
    } else {
      if (!jQuery('.prof-degree-other').hasClass('hidden')){
           jQuery('.prof-degree-other').addClass('hidden') 
      }
    }
  });
/*function gatherInfo(){
