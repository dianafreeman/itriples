...
<article id="post-<?php the_ID(); ?>" class="col-sm-12">
	<div class="card border-dark mb-3" >
		...
		<div class="card-body row">
			...
			<div class="col-sm-12">
				<?php 
				if (($filetype == "Link") && ($hasShortForm == "Yes")) { ?>
					<a class="col-sm-5 mb-1 offset-sm-1 btn btn-outline-info file-download" target="_blank" href="<?php echo esc_url(get_field('file_link')) ;?>">
						Download Full Form 
					<?php } else if (($filetype == "Link") && ($hasShortForm == "No"))  { ?>
						...
						<?php } else if (($filetype == "File") && ($hasShortForm == "Yes")) {?>
						...
						<?php } else if ( ($filetype == "File") && ($hasShortForm == "No") ) {?>
