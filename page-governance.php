  ...
  <section id="primary" class="content-area col-lg-9">
    ...
    <div class="row" id="governance">
      ...
      <div class="col-lg-4 col-sm-6 text-center mb-4">
        ...
        <div class="col-lg-4 col-sm-6 text-center mb-4">
          <div class="rounded-circle eboard-img d-block mx-auto" style="background-image: url(<?php echo get_stylesheet_directory_uri().'/assets/imgs/headshots/muehlenkamp.jpg' ?>)"></div>
          <div class="person-info-box">
        ...
        <div class="col-lg-4 col-sm-6 text-center mb-4">
          ...
          <div class="person-info-box">
            ...
            <p>Treasurer<br>
             ...
             <div class="social-icons">
              <!--<a class="ico" target="_blank" ><i class="fab fa-twitter"></i></a><a class="ico" target="_blank" ><i class="fab fa-linkedin"></i></a>--><a class="ico" target="_blank" href="https://www.nm.org/doctors/1962628586/jason-j-washburn-phd"><i class="fas fa-desktop"></i></a>
            </div>
          </div>
        </div>
        <div class="col-lg-4 col-sm-6 text-center mb-4">
          <div class="rounded-circle eboard-img d-block mx-auto" style="background-image: url(<?php echo get_stylesheet_directory_uri().'/assets/imgs/headshots/taliaferro.jpg' ?>)"></div>
          <div class="person-info-box">
            <h3>Lindsay Taliaferro Ph.D</h3>
            <p>Treasurer<br>
              <small><em>University of Central Florida</em></small></p>
              <div class="social-icons">
                <!--<a class="ico" target="_blank" ><i class="fab fa-twitter"></i></a><a class="ico" target="_blank" ><i class="fab fa-linkedin"></i></a>--><a class="ico" target="_blank" href="https://med.ucf.edu/directory/lindsay-taliaferro-ph-d-m-p-h-m-s/"><i class="fas fa-desktop"></i></a>
              </div>
            </div>
          </div>

          <div class="col-lg-4 col-sm-6 text-center mb-4">
            <div class="rounded-circle eboard-img d-block mx-auto" style="background-image: url(<?php echo get_stylesheet_directory_uri().'/assets/imgs/headshots/styer.jpg' ?>)"></div>
            <div class="person-info-box">
              <h3>Denise Styer, Psy.D</h3>
              <p>Secretary<br>
               <small><em>Denise Styer Coaching and Consultation</em></small></p>
               <div class="social-icons">
          ...
          <div class="col-lg-4 col-sm-6 text-center mb-4">
            ...
            <div class="person-info-box">
              ...
              <p>Representative at Large<br>
                ...
                <div class="social-icons">
                 <!-- <a class="ico" target="_blank" ><i class="fab fa-twitter"></i></a><a class="ico" target="_blank" ><i class="fab fa-linkedin"></i></a>--><a class="ico" target="_blank" href="https://www.sarahevictor.com/"><i class="fas fa-desktop"></i></a>
               </div>
             </div>
           </div>
